...
create table cb.basic_parameter (
param_group_key   varchar(50) not null  comment '参数组的key',
param_name        varchar(100) comment '参数名',
param_key         varchar(50) not null comment '参数key，param_group_key + param_key确定唯一数据',
