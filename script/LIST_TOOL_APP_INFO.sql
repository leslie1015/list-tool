...
comment on table xgbj.list_tool_app_info  is  '使用列表工具的微服务应用信息表';
COMMENT ON COLUMN xgbj.list_tool_app_info.appCode IS '应用代码';
COMMENT ON COLUMN xgbj.list_tool_app_info.appName IS '应用名称';
